...
<script>
    ...
    import CategoriesDialog from '@/components/posts/dialogs/Categories.vue';
    import ConfirmDialog from '@/components/shared/ConfirmDialog.vue';
    import CategoryChildren from '@/components/posts/dialogs/CategoriesChilldren.vue';
    ...
    export default {
        ...
        methods: {
            async fetchData() {
                try {
                    await this.$store.dispatch('posts/categories/fetchAll');
                } catch (error) {
